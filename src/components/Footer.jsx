...
export default function Footer() {
  return (
    <div className="bg-gray-100 p-4 md:p-6 text-xs sm:text-sm">
      {/* QR Codes Row */}
      <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-4 sm:mb-6">
        {[1, 2, 3, 4].map((num) => (
          <div key={num} className="flex flex-col items-center px-1 sm:px-0">
            <div className="bg-white p-1 sm:p-2 border border-gray-200 rounded">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-gray-800 rounded">
                {/* QR Code - Replace with actual image */}
                <div className="w-24 h-24 bg-gray-800">
                {/* QR Code */}
                <img 
            ...
            <div className="text-xs mt-10 sm:mt-2 text-gray-600">rera.kerala.gov.in</div>
            <div className="text-xs text-gray-600">K-RERA/PRJ/251/2020</div>
          </div>
        ))}
      </div>
      ...
      <div className="text-center mb-4 sm:mb-6 space-y-1">
        <p>Agent RERA No. – K-RERA/AG/0134/2023</p>
        <p>Project RERA – Phase 1- K-RERA/PRJ/251/2020</p>
        <p>Phase 2- K-RERA/PRJ/252/2020</p>
        <p>Phase 3- K-RERA/PRJ/253/2020</p>
        <p>Phase 4- K-RERA/PRJ/ERN/076/2023</p>
        <p>
          (<a href="https://rera.kerala.gov.in/" className="text-blue-500 hover:underline">
      ...
      <div className="mb-4 sm:mb-6 px-2 sm:px-4">
        <p className="text-justify leading-relaxed">
          Disclaimer: The information provided on this website is intended exclusively for informational purposes and should not be construed as an offer of services. This site is managed by a RERA authorized affiliate partner / real estate agent (for multiple real estate developers) namely RealTheory Private Limited. The pricing information presented on this website is subject to alteration without advance notification, and the assurance of property availability cannot be guaranteed. The images showcased on this website are for representational purposes only and may not accurately reflect the actual properties. We may share your data with Kerala Real Estate Regulatory Authority (RERA) registered Developers for further processing as necessary. Additionally, we may send updates and information to the mobile number or email address registered with us. All rights reserved. The content, design, and information on this website are protected by copyright and other intellectual property rights. Any unauthorized use or reproduction of the content may violate applicable laws. For accurate and up-to-date information regarding services, pricing, availability, and any other details, it is recommended to contact us directly through the provided contact information on this website. Thank you for visiting our website.
        </p>
      </div>

      {/* Bottom Links */}
      <div className="text-center mb-2 sm:mb-4 space-x-4">
      ...
      <div className="text-center text-gray-600">
        <p>All Rights Reserved. © 2025 RealTheory Pvt. Ltd.</p>
      </div>
    </div>
  );
}